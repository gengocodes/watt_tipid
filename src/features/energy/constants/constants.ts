...
export const ICONS_CONFIG: IconConfig[] = [
  ...
  },
  {
    ...
    icon: Wind,
    color: "text-teal-500",
    activeClass: "ring-2 ring-teal-500 border-teal-300 bg-teal-50/50 text-teal-600",
  },
  {
    value: "tv",
    label: "TV",
    ...
    activeClass: "ring-2 ring-indigo-500 border-indigo-300 bg-indigo-50/50 text-indigo-600",
  },
  {
    value: "smartphone",
    label: "Device",
    ...
    activeClass: "ring-2 ring-purple-500 border-purple-300 bg-purple-50/50 text-purple-600",
  },
  {
    value: "laundry",
    label: "Laundry",
    icon: Waves,
    color: "text-cyan-500",
    activeClass: "ring-2 ring-cyan-500 border-cyan-300 bg-cyan-50/50 text-cyan-600",
  },
  {
    value: "refrigerator",
    label: "Fridge",
    ...
    activeClass: "ring-2 ring-orange-500 border-orange-300 bg-orange-50/50 text-orange-600",
  },
  {
    value: "kettle",
    label: "Stove",
    ...
    activeClass: "ring-2 ring-amber-500 border-amber-300 bg-amber-50/50 text-amber-600",
  },
  {
    value: "lightbulb",
    label: "Light",
    ...
    activeClass: "ring-2 ring-yellow-500 border-yellow-300 bg-yellow-50/50 text-yellow-600",
  },
  {
    value: "plug",
    label: "Other",
    ...
    activeClass: "ring-2 ring-slate-500 border-slate-300 bg-slate-55 bg-slate-50 text-slate-700",
  },
];
...
export const STATUS_THEMES: Record<string, StatusTheme> = {
  Excellent: {
    ...
    description: "Superb energy savings! Keep maintaining your efficient lifestyle.",
  },
  Good: {
    strokeClass: "stroke-teal-500",
    textClass: "text-teal-600",
    bgTrail: "stroke-teal-100/30",
    description: "Great job saving power! You are doing better than most PH households.",
  },
  Fair: {
    strokeClass: "stroke-amber-500",
    textClass: "text-amber-600",
    bgTrail: "stroke-amber-100/30",
    description: "Moderate energy saving. Check our savings recommendations for improvements.",
  },
  Poor: {
    strokeClass: "stroke-rose-500",
    textClass: "text-rose-600",
    bgTrail: "stroke-rose-100/30",
    description: "There's room to improve. Check our AI advisor for customized savings tips.",
  },
};
